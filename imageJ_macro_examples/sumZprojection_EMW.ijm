...
//Used script "maxZprojection_MP.ijm" from Meng Pan and modified it to make "sum intensity projections". Eva Wenzel 01.11.2022


run("Bio-Formats Macro Extensions");

dir = getDirectory("Choose a Directory ");
out_dir = dir+"sum_projected";
...
saveAs("Tiff", out_dir+File.separator+"SUM_"+name);
close();
selectWindow(name);
close();
